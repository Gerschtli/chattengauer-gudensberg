...
<SimpleLayout.Root title="Impressum">
	<SimpleLayout.Section class="space-y-4">
		...
		<p>
			<strong>Vertreten durch den Vorsitzenden</strong>
			<br />
			Martin Salfer
			<br />
			Zur Sternwarte 3
		...
		<ul class="list-inside list-disc">
			<li>
				...
				>
					https://www.facebook.com/originalchattengauer/
				</a>
			</li>
			<li>
				Instagram: <a
					...
					rel="noopener noreferrer"
				>
					https://www.instagram.com/original.chattengauer/
				</a>
			</li>
			<li>
				TikTok: <a
					...
					rel="noopener noreferrer"
				>
					https://www.tiktok.com/@chattengauer/
				</a>
			</li>
		</ul>
		...
		<p>
			...
			Rechtsverletzungen werden wir derartige Inhalte umgehend entfernen. Datenschutz Die Nutzung unserer Webseite
			...
			weitergegeben. Wir weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der Kommunikation per
			E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist
			nicht möglich. Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten durch Dritte
			zur Übersendung von nicht ausdrücklich angeforderter Werbung und Informationsmaterialien wird hiermit
